...
{{NULL,      ".+\\.csv"          }, {"column", "-t", "-s", ",", "%piscou-filename%"}},
...
{{"appl.+/csv",              NULL}, {"column", "-t", "-s", ",", "%piscou-filename%"}},
...
{{"fpath \\.ff$",            NULL}, {"stiv", "%piscou-filename%", "%piscou-extra0%", "%piscou-extra1%", "%piscou-extra2%", "%piscou-extra3%"}},
{{"fpath \\.hdr$",           NULL}, {"hdr.sh", "%piscou-filename%", "%piscou-extra0%", "%piscou-extra1%", "%piscou-extra2%", "%piscou-extra3%"}},
{{"fpath .+\\.[1-9]$",       NULL}, {"man", "%piscou-filename%"}},
{{"fpath .+\\.sent",         NULL}, {"/usr/bin/cat", "%piscou-filename%"}},
{{"image/.*dwg",             NULL}, {"stat", "%piscou-filename%"}},
{{"image/.*xml",             NULL}, {"head", "-n", "40", "%piscou-filename%"}},
{{"image/.*",                NULL}, {"stiv", "%piscou-filename%", "%piscou-extra0%", "%piscou-extra1%", "%piscou-extra2%", "%piscou-extra3%"}},
