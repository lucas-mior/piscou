...
{{NULL,            ".+\\.gif$"}, {"chafa", "--clear", "#piscou-file#", "-s", "#piscou-0#x#piscou-1#", "--animate=false", "--polite=on", "--format=sixel"}},
{{NULL,           ".+\\.webp$"}, {"chafa", "--clear", "#piscou-file#", "-s", "#piscou-0#x#piscou-1#", "--animate=false", "--polite=on", "--format=sixel"}},
{{"image/.*",             NULL}, {"chafa", "--clear", "#piscou-file#", "-s", "#piscou-0#x#piscou-1#", "--animate=false", "--polite=on", "--format=sixel"}},
