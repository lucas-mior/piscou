...
{{"appl.+/epub.+",        NULL}, {"epub.sh", "%piscou-filename%", "%piscou-extra0%", "%piscou-extra1%", "%piscou-extra2%", "%piscou-extra3%"}},
{{"appl.+/csv",           NULL}, {"csv.sh", "%piscou-filename%"}},
{{"appl.+/json",          NULL}, {"head", "-n", "40", "%piscou-filename%"}},
{{"appl.+/js",            NULL}, {"bat",  "%piscou-filename%"}},
{{"appl.+/javascript",    NULL}, {"bat",  "%piscou-filename%"}},
...
{{"text/.+",              NULL}, {"b2t", "-p", "--pager=never", "--color=always", "%piscou-filename%"}},
};
